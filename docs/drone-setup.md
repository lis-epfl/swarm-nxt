...
Then, apply the [saved parameter file](https://raw.githubusercontent.com/lis-epfl/swarm-nxt/refs/heads/main/docs/params/nxt_params.params) (which you can find in the swarm-nxt clone repo: `swarm-nxt/docs/params/nxt_params.params`) by following the steps below: 
